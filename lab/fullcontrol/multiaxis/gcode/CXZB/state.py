...
from lab.fullcontrol.multiaxis.gcode.CXZB.point import Point
from lab.fullcontrol.multiaxis.gcode.CXZB.printer import Printer
...
class State(BaseModel):
    ...
    system_point: Optional[Point] = Point()
    i: Optional[int] = 0
    gcode: Optional[list] = []
    ...
    def __init__(self, steps: list, gcode_controls: GcodeControls):
        ...
        primer_steps.append(first_CXZB_point(steps))
