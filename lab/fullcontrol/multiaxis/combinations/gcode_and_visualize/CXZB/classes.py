from lab.fullcontrol.multiaxis.gcode.CXZB.point import Point as FourAxisPoint
from fullcontrol.combinations.gcode_and_visualize.classes import Point as ThreeAxisPoint
from lab.fullcontrol.multiaxis.gcode.CXZB.printer import Printer as FourAxisPrinter
from fullcontrol.combinations.gcode_and_visualize.classes import Printer as ThreeAxisPrinter
from lab.fullcontrol.multiaxis.gcode.CXZB.controls import GcodeControls as FourAxisGcodeControls
...
class Point(FourAxisPoint, ThreeAxisPoint):
    '''x y z b position of the nozzle. if any of CXZB are not defined, the nozzle will not move in that 
